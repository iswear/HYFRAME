...
HY.GUI.TimeLineRule.prototype.defaultMinDuration = 10;
...
HY.GUI.TimeLineRule.prototype.initConstraint = function(){
    ...
    this.addEventListener("paint",this._paintTimeLineRule,this);
    this.setMinLayoutWidth(this._minDuration * this._secondDivide * this._frameWidth);
}
