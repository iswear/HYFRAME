...
hy.html.TextBox.prototype.init = function(config){
    ...
    if(hy.platform.isMobile()){
        ...
        hy.event.addEventListener(this._htmlTextBox,"mousewheel",this,function(e){
            var e = event ? event : e;
            try{
                var height = hy.dom.parsePxStrToInt(this._htmlTextBox.style.height);
                var wheelDelta = e.wheelDelta ? e.wheelDelta : e.detail;
                if(wheelDelta > 0){
                    if(this._htmlTextBox.scrollTop +  height < this._htmlTextBox.scrollHeight){
                        var deltaTop = this._htmlTextBox.scrollHeight - height;
                        this._htmlTextBox.scrollTop += (deltaTop > 20) ? 20 : deltaTop;
                    }
                }else{
                    if(this._htmlTextBox.scrollTop > 0){
                        this._htmlTextBox.scrollTop -= (this._htmlTextBox.scrollTop > 20) ? 20 : this._htmlTextBox.scrollTop;
                    }
                }
                e.stopPropagation();
            }catch(err){
...
hy.html.TextBox.prototype.showForNode = function(node){
    if(node && this._inputNode != node){
        ...
        if(width > 0 && height > 0){
            ...
            this._htmlTextBox.style.maxHeight = height + "px";
            /*背景*/
