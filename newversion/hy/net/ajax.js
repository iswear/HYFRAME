...
hy.net.Ajax.prototype.init = function(config){
    ...
    this._URL = this.isUndefined(config.URL) ? null : config.URL;
    this._args = this.isUndefined(config.args) ? null : config.args;
    this._mode = this.isUndefined(config.mode) ? null : config.mode;
