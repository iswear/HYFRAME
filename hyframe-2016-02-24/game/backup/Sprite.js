...
HY.Game.Sprite.prototype = new HY.Game.Model();
HY.Game.Sprite.prototype.defaultDragEnable = true;
HY.Game.Sprite.prototype.initConstraint = function(){
...
HY.Game.Sprite.prototype.walkTo = function(pPosition){
	if(pPosition.x != this.getX() || pPosition.y != this.getY()){
		this.stopActionWithClass(1,true);
