...
hy.RenderContext.prototype.notifySyncSize = "syncsize";
...
hy.RenderContext.prototype.init = function(config){
    ...
    this._width = this.isUndefined(config.width) ? this._width : config.width;
    this._height = this.isUndefined(config.height) ? this._height : config.height;
    this._canvas = this.isUndefined(config.canvas) ? (document.createElement("canvas")) : config.canvas;
    this.__context = null;
    this.__statusStack = [];
    this.__statusCur = {};

    if(this._canvas){
        this.addObserver(this.notifySyncSize,this,this._syncCanvasSize);
    }
}
...
hy.RenderContext.prototype.setSize = function(width,height){
    if(this._width != width || this._height != height){
        this._width = width;
        this._height = height;
        this.postNotification(this.notifySyncSize, null);
    }
}
hy.RenderContext.prototype.getSize = function(){
    return {width:this._width,height:this._height};
}
hy.RenderContext.prototype.setCanvas = function(canvas){
    if(this._canvas != canvas){
        ...
        if(this._canvas){
            ...
            this.removeObserver(this.notifySyncSize,this,this._syncCanvasSize);
        }
    }
}
...
hy.RenderContext.prototype._syncContext = function(){
...
//    this.__context.shadowColor = this.__statusCur.shadowColor;
//    this.__context.shadowBlur = this.__statusCur.shadowBlur;
//    this.__context.shadowOffsetX = this.__statusCur.shadowOffsetX;
//    this.__context.shadowOffsetY = this.__statusCur.shadowOffsetY;
//    this.__context.lineCap = this.__statusCur.lineCap;
//    this.__context.lineJoin = this.__statusCur.lineJoin;
//    this.__context.lineWidth = this.__statusCur.lineWidth;
//    this.__context.miterLimit = this.__statusCur.miterLimit;
//    this.__context.font = this.__statusCur.font;
//    this.__context.textAlign = this.__statusCur.textAlign;
//    this.__context.textBaseline = this.__statusCur.textBaseline;
